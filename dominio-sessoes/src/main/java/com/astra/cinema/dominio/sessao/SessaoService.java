...
public class SessaoService {
    ...
    public Sessao criarSessao(Funcionario funcionario, FilmeId filmeId, Date horario, Map<AssentoId, Boolean> assentos) {
        ...
        // TODO: Aceitar salaId como parâmetro quando os Use Cases forem atualizados
        var salaId = new SalaId(1); // Temporário - deve vir como parâmetro
        var sessao = new Sessao(null, filmeId, horario, StatusSessao.DISPONIVEL, mapaAssentos, salaId);
