...
-- Inserindo usuários para login (IMPORTANTE: senhas em texto plano apenas para demonstração!)
...
-- Inserindo filmes (imagem_url será adicionada na V3)
...
(1, NOW() + INTERVAL '1 day 10 hours', 'DISPONIVEL', 50),
(1, NOW() + INTERVAL '1 day 14 hours', 'DISPONIVEL', 50),
(1, NOW() + INTERVAL '1 day 19 hours', 'DISPONIVEL', 50),
(2, NOW() + INTERVAL '1 day 11 hours', 'DISPONIVEL', 50),
(2, NOW() + INTERVAL '1 day 16 hours', 'DISPONIVEL', 50),
(2, NOW() + INTERVAL '1 day 21 hours', 'DISPONIVEL', 50),
(3, NOW() + INTERVAL '1 day 13 hours', 'DISPONIVEL', 50),
(3, NOW() + INTERVAL '1 day 18 hours', 'DISPONIVEL', 50);
